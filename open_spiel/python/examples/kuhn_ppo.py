...
flags.DEFINE_float("critic_lr", 1e-3, "learning rate of critic network. Also learning rate of PPO.")
flags.DEFINE_float("pi_lr", 1e-3, "learning rate of policy network")
flags.DEFINE_float('etpcost', 1e-4, "entropy cost")
flags.DEFINE_integer('nctopi', 1, "num critic before pi")
flags.DEFINE_string("optm", "rms", "optimizer for training ['sgd', 'adam', 'rms']")
flags.DEFINE_float("clip_param", 0.1, "threshold for clip method")
